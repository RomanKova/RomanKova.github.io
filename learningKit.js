window.onload = function(){
        ...
        var buttonCaption = ["Addition", "Triangle", "Real-Roots", "Roots", "GPA",
							 "Number-Sign", "Total-Sign", "Divisible By 6", "Digits <-", "Number of 3",
							 "Digit Sum", "Palindrome", "Factorial", "Fibonacci", "Draw △",
							 "○  Area", "Oval Area", "Decending", "Prime", "Sum","GCD","mTable", "Random","Doubles","Array","Product 1-10","Product Rand","RGB","","Random Prime",
               "Day","WakeUp","Derivative","&Pi;","Watts","Vol Sphere","Vol Cylinder","",""," "];
...
function area() {
  ...
  var c=parseInt(document.getElementById("num3").value);
        var s = Math.sqrt((w + h + c) / 2 * ((w + h + c) / 2 - w) * ((w + h + c) / 2 - h) * ((w + h + c) / 2 - c));
		s = s.toFixed(2)
...
function equation() {
  ...
  var c=parseInt(document.getElementById("num3").value);
		...
		s = s.toFixed(2);
		s2 = s2.toFixed(2);
  document.getElementById("output").innerHTML="one root: "+s + "<br>another: " + s2;
}
...
function problem24() {
	...
	if(value1 == value2)
	outputObj.innerHTML = "DOUBLES";
	else
	outputObj.innerHTML = "NOT DOUBLES";
